...
%\usepackage{tocbasic} % has to be infront of scripts/appendixtoc
%%% this script also interfers with listoftables and listoffigures...
%%% not sure how to proceed with the appendix
%\usepackage{scripts/appendixtoc}
