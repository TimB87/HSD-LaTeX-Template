...
\lstinputlisting[linerange={150-152},float=htpb,caption=Relavanter Code für das Abkürzungsverzeichnis,label=lst:our-acros]{meta/preambel.tex}
...
\lstinputlisting[linerange={154-159},float=htpb,caption=Relevanter Code für unser Glossar,label=lst:our-glo]{meta/preambel.tex}
...
\lstinputlisting[linerange={161-164},float=htpb,caption=Relevanter Code für unseren Index,label=lst:our-idx]{meta/preambel.tex}
