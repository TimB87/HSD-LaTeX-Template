...
Zusätzlich ist die Option \glqq draft\grqq bei größeren Dokumenten Hilfreich, denn es verarbeitet nicht alle Informationen und spart dadurch Zeit beim kompilieren. Diese Vorlage wird z.B. aus diesen Gründen im ersten Durchlauf ebenfalls nur als draft Variante kompiliert, da wir praktisch nur die Output-Dateien brauchen, die weiter als Input für \hologo{biber}, makeglossaries und xindy dienen.

Das Paket geometry setzt das Seitenlayout auf die gewünschten Einheiten.

Wichtig zum problemfreien Einsatz der KOMA-Klasse ist, dass ihr das Paket \glqq fancyhdr\grqq\ meidet, da es dafür eigene Befehle und Werkzeuge gibt. Ich verweise hier auf den Quellcode~\ref{lst:our-heafoo}.

\lstinputlisting[firstline=19,lastline=42,float=htpb,caption=Der relavente Code für Header und Footer,label=lst:our-heafoo]{meta/preambel.tex}
...
\end{lstlisting}
Relevanter Code:
\lstinputlisting[firstline=129,lastline=149,float=htpb,caption=Relevanter Code für biblatex,label=lst:our-bib]{meta/preambel.tex}
...
\multicolumn{1}{|l|}{autocite} & footnote & Setzt eine Fußnote \\ \hline
 & cite & setzt den Verweis direkt im Text \\ \hline
...
\lstinputlisting[firstline=146,lastline=154,float=htpb,caption=Relavanter Code für das Abkürzungsverzeichnis,label=lst:our-acros]{meta/preambel.tex}
%}}}
...
\lstinputlisting[firstline=156,lastline=161,float=htpb,caption=Relevanter Code für unser Glossar,label=lst:our-glo]{meta/preambel.tex}
...
\lstinputlisting[firstline=163,lastline=167,float=htpb,caption=Relevanter Code für unseren Index,label=lst:our-idx]{meta/preambel.tex}%}}}
%}}}
