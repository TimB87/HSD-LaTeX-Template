...
\end{lstlisting}
Relevanter Code:
\lstinputlisting[firstline=135,lastline=156,float=htpb,caption=Relevanter Code für biblatex,label=lst:our-bib]{meta/preamble.tex}
...
\lstinputlisting[firstline=159,lastline=168,float=htpb,caption=Relavanter Code für das Abkürzungsverzeichnis,label=lst:our-acros]{meta/preamble.tex}
%}}}
...
\lstinputlisting[firstline=170,lastline=175,float=htpb,caption=Relevanter Code für unser Glossar,label=lst:our-glo]{meta/preamble.tex}
...
\lstinputlisting[firstline=177,lastline=180,float=htpb,caption=Relevanter Code für unseren Index,label=lst:our-idx]{meta/preamble.tex}%}}}
%}}}
